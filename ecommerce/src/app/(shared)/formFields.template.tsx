...
export const FullNameInput = ({ form, field, props }: InputProps) => {
...
export const EmailInput = ({ form, field, props }: InputProps) => {
...
export const CommentaryInput = ({ form, field, props }: InputProps) => {
