                ...
                {[
                    <>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                ...
                                <TableRow>
                                    <TableCell>
                                        <Paragraph>
                                            ...
                                            Санкт-Петербург, ул. Заозерная, д.
                                            3к2
                                        </Paragraph>
                                    </TableCell>
                                    <TableCell>
                                ...
                                <TableRow>
                                    <TableCell>
                                        <Paragraph>
                                            Пункт выдачи заказов: Нижний
                                            Новгород, ул. Саврасова, д. 32
                                        </Paragraph>
                                    </TableCell>
                                    <TableCell>
                                        <Paragraph>в день заказа,</Paragraph>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell>
                                        ...
                                        <Paragraph>
                                            отправка осуществляется в часы
                                            работы пункта выдачи заказов
                                        </Paragraph>
                                    </TableCell>
                                </TableRow>
                        ...
                        <AttentionText props={underTableTextProps}>
                            Доставка по Москве (в пределах МКАД) и
                            Санкт-Петербургу (в пределах КАД) курьером
                            Telescope1.ru при заказе от 10 000 p осуществляется
                            бесплатно в тот же, либо на следующий рабочий день.
                        </AttentionText>
                    </>,
                    ...
                    <>
                        ...
                        <Paragraph>
                            После того как Вы осмотрели покупку и убедились, что
                            все в порядке, Вы платите курьеру наличными или
                            картой.
                        </Paragraph>
                    </>
                ]}
